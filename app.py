    ...
    def main():
        ...
        if activity == 'Prediction':
            ...
            with col_2:
                ...
                proxtodistalratio = st.number_input ("Proximal ureter diameter (mm)", 0, 50)/st.number_input ("Distal ureter diameter (mm)", 1, 50)
                ProxDistal = ((st.number_input ("Proximal ureter diameter (mm)", 0, 50))-(st.number_input ("Distal ureter diameter (mm)", 1, 50)))
        ...
        if activity == 'About':
            ...
            with about_container3:
                ...
                with col_7:
                    st.image('validation.png')
                    st.caption('Validation curve of the logistic regression model.')
